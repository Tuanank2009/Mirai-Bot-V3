var traloi1 = ["Ỏ , lệnh của mình là: !",
  ...
  "Facebook admin: facebook.com/anhyeuemnhamlun",
  "Nếu có việc gì thì thì liên hệ admin nhé:3",
  "Trong trường hợp bot không onl thì nhắn tin với admin qua fb: facebook.com/anhyeuemnhamlun",
  "Có vấn đề gì thì hãy ib admin",
  "Mua file bot ib mình: facebook.com/anhyeuemnhamlun",
